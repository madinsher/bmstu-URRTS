...
одновременно:
  ...
  3) с момента своей заявки прошло не меньше settle секунд (соседи успели её услышать).
...
class Traffic:
    ...
    def may_enter(self, cell, neighbours, now):
        """Можно ли зарезервировать клетку cell сейчас (правила 1–3 из заголовка модуля).
